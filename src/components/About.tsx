            ...
            <div className="about-inner-container">
                <div className="about-item-1">
                    ...
                    <p>
                        ...
                        a kid with free Angelfire and GeoCities websites. In my youth I
                        thought it was the coolest thing copying source code from other
                        sites then adding it to my free site. While I didn't build anything
                        of note the spark was there. I later went on to college at the
                        University of Houston, where I majored in Biotechnology.
                    </p>
                    <h3>Education</h3>
                    ...
                    <ul className="skills">
                        ...
                        <li>Axios</li>
                        <li>
                            <span style={{ color: "turquoise" }}>React</span>
                        </li>
                        <li>
                            <span style={{ color: "blue" }}>TailwindCSS</span>
                        </li>
                    </ul>
                    <h4>Back-end & Database Skills</h4>
                    <ul className="skills">
                        <li>
                            <span style={{ color: "maroon", fontWeight: "bold" }}>RUST</span>
                        </li>
                        <li>Prisma</li>
                        <li>SQLite</li>
                        <li>PostgreSQL</li>
